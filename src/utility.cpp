...
void loadKeywords(std::vector<Keyword> &KeyWords) {
    std::string* keywords = new std::string[18];
    std::string* descriptions = new std::string[18];

    get_from_file_to_array("keywords.voi",keywords,18,' ');
    get_from_file_to_array("descriptions.voi",descriptions,18,',');
